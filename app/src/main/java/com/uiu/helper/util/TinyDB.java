...
public class TinyDB {
     ...
     */
    public CopyOnWriteArrayList<String> getListString(String key) {
        return new CopyOnWriteArrayList<String>(Arrays.asList(TextUtils.split(preferences.getString(key, ""), "‚‗‚")));
    }
    ...
    public ArrayList<Boolean> getListBoolean(String key) {
        CopyOnWriteArrayList<String> myList = getListString(key);
...
//    }
     ...
     */
    public void putListString(String key, CopyOnWriteArrayList<String> stringList) {
        checkForNullKey(key);
     ...
     */
    public void putListBoolean(String key, CopyOnWriteArrayList<Boolean> boolList) {
        checkForNullKey(key);
