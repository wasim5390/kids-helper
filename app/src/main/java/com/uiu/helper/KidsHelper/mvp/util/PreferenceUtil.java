...
public class PreferenceUtil {
    ...
    public Setting getKidDeviceSettings(String key_kid_id){
        Gson gson = new Gson();
        Setting settings = gson.fromJson(sPref.getString(key_kid_id,""),new TypeToken<Setting>() {
        }.getType());

        return settings==null?new Setting():settings;
    }


    public void saveKidsDeviceSettings(String key_kid_id,Setting setting){
        Gson gson = new Gson();
        String str = gson.toJson(setting);
        SharedPreferences.Editor editor = sPref.edit();
        editor.putString(key_kid_id, str);
        editor.apply();
    }
