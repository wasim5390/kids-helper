...
public class ApplicationJsonPutRequest extends ApplicationJsonRequest {

    Vector<NameValuePair> paramsVector = null;
    ArrayList<BasicNameValuePair> paramsArray = null;
    String requestBody = null;

    public ApplicationJsonPutRequest(String url, Vector<NameValuePair> params, Listener<NetworkResponse> listener, ErrorListener errorListener) {

        super(Request.Method.PUT, url,  "", listener, errorListener);
        this.paramsVector = params;
    }

    public ApplicationJsonPutRequest(String url, ArrayList<BasicNameValuePair> params, Listener<NetworkResponse> listener, ErrorListener errorListener) {

        super(Request.Method.PUT, url,  "", listener, errorListener);
        this.paramsArray = params;
    }

    public ApplicationJsonPutRequest(String url, String requestBody, Listener<NetworkResponse> listener, ErrorListener errorListener) {
